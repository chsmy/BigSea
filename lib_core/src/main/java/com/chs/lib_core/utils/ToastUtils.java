...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = AppUtil.getApp().getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        AppUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(AppUtil.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        AppUtil.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(AppUtil.getApp());
                iToast.setView(view);
